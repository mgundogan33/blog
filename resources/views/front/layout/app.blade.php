...
<!-- Mirrored from gmag.kwst.net/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Jan 2023 16:31:53 GMT -->
...
<body>
    ...
    <div id="main">
                        ...
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="bg-wrap">
                                        <div class="bg" data-bg="{{ asset('front/images/all/20.jpg') }}" data-swiper-parallax="40%">
                                        </div>
                                    ...
                                    <div class="hero-item fl-wrap">
                                        <div class="container">
                                            ...
                                            <div class="author-link"><a href="author-single.html"><img
                                                        src="{{ asset('front/images/avatar/4.jpg') }}" alt=""> <span>By Jessie
                                                        Bond</span></a></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="bg-wrap">
                                        <div class="bg" data-bg="{{ asset('front/images/all/55.jpg') }}" data-swiper-parallax="40%">
                                        </div>
                                        <div class="overlay"></div>
                                    </div>
                                    <div class="hero-item fl-wrap">
                                        <div class="container">
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="author-link"><a href="author-single.html"><img
                                                        src="{{ asset('front/images/avatar/3.jpg') }}" alt=""> <span>By Ann
                                                        Kowalsky</span></a></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="bg-wrap">
                                        <div class="bg" data-bg="{{ asset('front/images/all/56.jpg') }}" data-swiper-parallax="40%">
                                        </div>
                                        <div class="overlay"></div>
                                    </div>
                                    <div class="hero-item fl-wrap">
                                        <div class="container">
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="author-link"><a href="author-single.html"><img
                                                        src="{{ asset('front/images/avatar/2.jpg') }}" alt=""> <span>By Mark
                                                        Rose</span></a></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="bg-wrap">
                                        <div class="bg" data-bg="{{ asset('front/images/all/57.jpg') }}" data-swiper-parallax="40%">
                                        </div>
                                        <div class="overlay"></div>
                                    </div>
                                    <div class="hero-item fl-wrap">
                                        <div class="container">
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="author-link"><a href="author-single.html"><img
                                                        src="{{ asset('front/images/avatar/1.jpg') }}" alt=""> <span>By Jane
                                                        Taylor</span></a></div>
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="hsc-list_item fl-wrap">
                                                <div class="hsc-list_item-media">
                                                    <div class="bg-wrap">
                                                        <div class="bg" data-bg="{{ asset('front/images/all/20.jpg') }}"></div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="hsc-list_item fl-wrap">
                                                <div class="hsc-list_item-media">
                                                    <div class="bg-wrap">
                                                        <div class="bg" data-bg="{{ asset('front/images/all/55.jpg') }}"></div>
                                                    </div>
                                                </div>
                                                <div class="hsc-list_item-content fl-wrap">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="hsc-list_item fl-wrap">
                                                <div class="hsc-list_item-media">
                                                    <div class="bg-wrap">
                                                        <div class="bg" data-bg="{{ asset('front/images/all/56.jpg') }}"></div>
                                                    </div>
                                                </div>
                                                <div class="hsc-list_item-content fl-wrap">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="hsc-list_item fl-wrap">
                                                <div class="hsc-list_item-media">
                                                    <div class="bg-wrap">
                                                        <div class="bg" data-bg="{{ asset('front/images/all/57.jpg') }}"></div>
                                                    </div>
                                                </div>
                                                <div class="hsc-list_item-content fl-wrap">
                        ...
                        <span>
                            <svg class="circ" width="30" height="30">
                                ...
                                <circle class="circ1" cx="15" cy="15" r="13"
                                    stroke="#e93314" stroke-width="2" fill="none" />
                            </svg>
                        </span>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="main-container fl-wrap fix-container-init">
                                    ...
                                    <div class="ajax-wrapper fl-wrap">
                                        <div class="ajax-loader"><img src="{{ asset('front/images/loading.gif') }}" alt="" />
                                        </div>
                                        <div id="ajax-content" class="fl-wrap">
                                        </div>
                                    </div>
                                    <div class="content-banner-wrap cbw_mar">
                                        <img src="{{ asset('front/images/all/banner.jpg') }}" class="respimg" alt="">
                                    </div>
                                    <div class="clearfix"></div>
                                            ...
                                            <div class="list-post-wrap list-post-wrap_column fl-wrap">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="list-post fl-wrap">
                                                            <a class="post-category-marker"
                                                                href="category.html">Science</a>
                                                            <div class="list-post-media">
                                                                <a href="post-single.html">
                                                                    <div class="bg-wrap">
                                                                        <div class="bg"
                                                                            data-bg="{{ asset('front/images/all/16.jpg') }}"></div>
                                                                    </div>
                                                                </a>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="list-post fl-wrap">
                                                            <a class="post-category-marker"
                                                                href="category.html">Sports</a>
                                                            <div class="list-post-media">
                                                                <a href="post-single.html">
                                                                    <div class="bg-wrap">
                                                                        <div class="bg"
                                                                            data-bg="{{ asset('front/images/all/24.jpg') }}"></div>
                                                                    </div>
                                                                </a>
                                                                <span class="post-media_title">&copy; Image Copyrights
                                                                    Title</span>
                                                ...
                                                <div class="swiper-container">
                                                    <div class="swiper-wrapper">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="grid-post-item  bold_gpi  fl-wrap">
                                                                <div class="grid-post-media gpm_sing">
                                                                    <div class="bg" data-bg="{{ asset('front/images/all/31.jpg') }}">
                                                                    </div>
                                                                    <div class="author-link"><a
                                                                            href="author-single.html"><img
                                                                                src="{{ asset('front/images/avatar/2.jpg') }}"
                                                                                alt=""> <span>By Mark
                                                                                Rose</span></a></div>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="grid-post-item  bold_gpi  fl-wrap">
                                                                <div class="grid-post-media gpm_sing">
                                                                    <div class="bg" data-bg="{{ asset('front/images/all/40.jpg') }}">
                                                                    </div>
                                                                    <div class="author-link"><a
                                                                            href="author-single.html"><img
                                                                                src="{{ asset('front/images/avatar/3.jpg') }}"
                                                                                alt=""> <span>Ann
                                                                                Kowalsky</span></a></div>
                                                                    <div class="grid-post-media_title">
                                                                        <a class="post-category-marker"
                                                                        ...
                                                                        <span class="video-date"><i
                                                                                class="far fa-clock"></i> 30 september
                                                                            2021</span>
                                                                        <ul class="post-opt">
                                                                            <li><i class="far fa-comments-alt"></i> 25
                                                                            </li>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="grid-post-item  bold_gpi  fl-wrap">
                                                                <div class="grid-post-media gpm_sing">
                                                                    <div class="bg" data-bg="{{ asset('front/images/all/36.jpg') }}">
                                                                    </div>
                                                                    <div class="author-link"><a
                                                                            href="author-single.html"><img
                                                                                src="{{ asset('front/images/avatar/1.jpg') }}"
                                                                                alt=""> <span>By Jane
                                                                                Taylor</span></a></div>
                                                                    <div class="grid-post-media_title">
                                                                        <a class="post-category-marker"
                                                                        ...
                                                                        <span class="video-date"><i
                                                                                class="far fa-clock"></i> 05 december
                                                                            2021</span>
                                                                        <ul class="post-opt">
                                                                            <li><i class="far fa-comments-alt"></i> 25
                                                                            </li>
                                                        ...
                                                        <div class="list-post fl-wrap">
                                                            ...
                                                            <div class="list-post-media">
                                                                <a href="post-single.html">
                                                                    <div class="bg-wrap">
                                                                        <div class="bg"
                                                                            data-bg="{{ asset('front/images/all/37.jpg') }}"></div>
                                                                    </div>
                                                                </a>
                                                                <span class="post-media_title">&copy; Image Copyrights
                                                                    Title</span>
                                                        ...
                                                        <div class="list-post fl-wrap">
                                                            ...
                                                            <div class="list-post-media">
                                                                <a href="post-single.html">
                                                                    <div class="bg-wrap">
                                                                        <div class="bg"
                                                                            data-bg="{{ asset('front/images/all/39.jpg') }}"></div>
                                                                    </div>
                                                                </a>
                                                                <span class="post-media_title">&copy; Image Copyrights
                                                                    Title</span>
                                                        ...
                                                        <div class="list-post fl-wrap">
                                                            ...
                                                            <div class="list-post-media">
                                                                <a href="post-single.html">
                                                                    <div class="bg-wrap">
                                                                        <div class="bg"
                                                                            data-bg="{{ asset('front/images/all/18.jpg') }}"></div>
                                                                    </div>
                                                                </a>
                                                                <span class="post-media_title">&copy; Image Copyrights
                                                                    Title</span>
                                                        ...
                                                        <div class="list-post fl-wrap">
                                                            ...
                                                            <div class="list-post-media">
                                                                <a href="post-single.html">
                                                                    <div class="bg-wrap">
                                                                        <div class="bg"
                                                                            data-bg="{{ asset('front/images/all/7.jpg') }}"></div>
                                                                    </div>
                                                                </a>
                                                                <span class="post-media_title">&copy; Image Copyrights
                                                                    Title</span>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="sidebar-content fl-wrap fix-bar">
                                                        ...
                                                        <div id="tab-popular" class="tab-content first-tab">
                                                            <div class="post-widget-container fl-wrap">
                                                                ...
                                                                <div class="post-widget-item fl-wrap">
                                                                    <div class="post-widget-item-media">
                                                                        <a href="post-single.html"><img
                                                                                src="{{ asset('front/images/all/thumbs/1.jpg') }}"
                                                                                alt=""></a>
                                                                    </div>
                                                                    <div class="post-widget-item-content">
                                                                        <h4><a href="post-single.html">How to start
                                                                                Home education.</a></h4>
                                                                        <ul class="pwic_opt">
                                                                ...
                                                                <div class="post-widget-item fl-wrap">
                                                                    <div class="post-widget-item-media">
                                                                        <a href="post-single.html"><img
                                                                                src="{{ asset('front/images/all/thumbs/2.jpg') }}"
                                                                                alt=""></a>
                                                                    </div>
                                                                    <div class="post-widget-item-content">
                                                                ...
                                                                <div class="post-widget-item fl-wrap">
                                                                    <div class="post-widget-item-media">
                                                                        <a href="post-single.html"><img
                                                                                src="{{ asset('front/images/all/thumbs/3.jpg') }}"
                                                                                alt=""></a>
                                                                    </div>
                                                                    <div class="post-widget-item-content">
                                                                ...
                                                                <div class="post-widget-item fl-wrap">
                                                                    <div class="post-widget-item-media">
                                                                        <a href="post-single.html"><img
                                                                                src="{{ asset('front/images/all/thumbs/4.jpg') }}"
                                                                                alt=""></a>
                                                                    </div>
                                                                    <div class="post-widget-item-content">
                                                        ...
                                                        <div id="tab-resent" class="tab-content">
                                                            <div class="post-widget-container fl-wrap">
                                                                ...
                                                                <div class="post-widget-item fl-wrap">
                                                                    <div class="post-widget-item-media">
                                                                        <a href="post-single.html"><img
                                                                                src="{{ asset('front/images/all/thumbs/5.jpg') }}"
                                                                                alt=""></a>
                                                                    </div>
                                                                    <div class="post-widget-item-content">
                                                                ...
                                                                <div class="post-widget-item fl-wrap">
                                                                    <div class="post-widget-item-media">
                                                                        <a href="post-single.html"><img
                                                                                src="{{ asset('front/images/all/thumbs/6.jpg') }}"
                                                                                alt=""></a>
                                                                    </div>
                                                                    <div class="post-widget-item-content">
                                                                ...
                                                                <div class="post-widget-item fl-wrap">
                                                                    <div class="post-widget-item-media">
                                                                        <a href="post-single.html"><img
                                                                                src="{{ asset('front/images/all/thumbs/7.jpg') }}"
                                                                                alt=""></a>
                                                                    </div>
                                                                    <div class="post-widget-item-content">
                                    ...
                                    <div class="box-widget fl-wrap">
                                        <div class="box-widget-content">
                                            <div id="weather-widget" class="ideaboxWeather" data-city="New York">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- box-widget  end -->
                                    ...
                                    <div class="box-widget fl-wrap">
                                        ...
                                        <div class="box-widget-content">
                                            ...
                                            <a href="#" target="_blank" class="btn float-btn color-btn">Read us
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="grid-post-item     fl-wrap">
                                                                <div class="grid-post-media gpm_sing">
                                                                    <div class="bg-wrap">
                                                                        <div class="bg"
                                                                            data-bg="{{ asset('front/images/all/21.jpg') }}"></div>
                                                                        <div class="overlay"></div>
                                                                    </div>
                                                                    <div class="grid-post-media_title">
                                                                        <a class="post-category-marker"
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="grid-post-item  bold_gpi  fl-wrap">
                                                                <div class="grid-post-media gpm_sing">
                                                                    <div class="bg-wrap">
                                                                        <div class="bg"
                                                                            data-bg="{{ asset('front/images/all/41.jpg') }}"></div>
                                                                        <div class="overlay"></div>
                                                                    </div>
                                                                    <div class="grid-post-media_title">
                                                                        <a class="post-category-marker"
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="grid-post-item  bold_gpi  fl-wrap">
                                                                <div class="grid-post-media gpm_sing">
                                                                    <div class="bg-wrap">
                                                                        <div class="bg"
                                                                            data-bg="{{ asset('front/images/all/22.jpg') }}"></div>
                                                                        <div class="overlay"></div>
                                                                    </div>
                                                                    <div class="grid-post-media_title">
                                                                        <a class="post-category-marker"
                            ...
                            <div class="video-links-wrap">
                                ...
                                <div class="video-item video-item_active fl-wrap" data-url="post-single2.html"
                                    ...
                                    <div class="video-item-img fl-wrap">
                                        <img src="{{ asset('front/images/all/33.jpg') }}" class="respimg" alt="">
                                ...
                                <div class="video-item fl-wrap" data-url="post-single2.html"
                                    ...
                                    <div class="video-item-img fl-wrap">
                                        <img src="{{ asset('front/images/all/43.jpg') }}" class="respimg" alt="">
                                        <div class="play-icon"><i class="fas fa-play"></i></div>
                                    </div>
                                    <div class="video-item-title">
                                ...
                                <div class="video-item fl-wrap" data-url="posts-ingle2.html"
                                    ...
                                    <div class="video-item-img fl-wrap">
                                        <img src="{{ asset('front/images/all/3.jpg') }}" class="respimg" alt="">
                                        <div class="play-icon"><i class="fas fa-play"></i></div>
                                    </div>
                                    <div class="video-item-title">
                                ...
                                <div class="video-item fl-wrap" data-url="post-single2.html"
                                    ...
                                    <div class="video-item-img fl-wrap">
                                        <img src="{{ asset('front/images/all/42.jpg') }}" class="respimg" alt="">
                                        <div class="play-icon"><i class="fas fa-play"></i></div>
                                    </div>
                                    <div class="video-item-title">
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="video-item fl-wrap">
                                                    <div class="video-item-img fl-wrap">
                                                        <img src="{{ asset('front/images/all/1.jpg') }}" class="respimg" alt="">
                                                        <a class="play-icon image-popup"
                                                            href="https://www.youtube.com/watch?v=65YhmHsuD-M"><i
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="video-item fl-wrap">
                                                    <div class="video-item-img fl-wrap">
                                                        <img src="{{ asset('front/images/all/44.jpg') }}" class="respimg" alt="">
                                                        <a class="play-icon image-popup"
                                                            href="https://vimeo.com/155428349"><i
                                                                class="fas fa-play"></i></a>
                                                    </div>
                                                    <div class="video-item-title">
                                                        <h4><a href="post-single2.html">Options, options: As clock
                                                                ticks on, climate talks </a></h4>
                                                        <span class="video-date"><i class="far fa-clock"></i>
                                                            05december 2021</span>
                                                    </div>
                                                    <a class="post-category-marker" href="category.html">Business</a>
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="video-item fl-wrap">
                                                    <div class="video-item-img fl-wrap">
                                                        <img src="{{ asset('front/images/all/2.jpg') }}" class="respimg" alt="">
                                                        <a class="play-icon image-popup"
                                                            href="https://vimeo.com/108359069"><i
                                                                class="fas fa-play"></i></a>
                                                    </div>
                                                    <div class="video-item-title">
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="video-item fl-wrap">
                                                    <div class="video-item-img fl-wrap">
                                                        <img src="{{ asset('front/images/all/46.jpg') }}" class="respimg" alt="">
                                                        <a class="play-icon image-popup"
                                                            href="https://www.youtube.com/watch?v=s-TySen2xLo"><i
                                                                class="fas fa-play"></i></a>
                                                    </div>
                                                    <div class="video-item-title">
                                ...
                                <div class="list-post-wrap list-post-wrap_column list-post-wrap_column_fw">
                                    ...
                                    <div class="list-post fl-wrap">
                                        ...
                                        <div class="list-post-media">
                                            <a href="post-single.html">
                                                <div class="bg-wrap">
                                                    <div class="bg" data-bg="{{ asset('front/images/all/15.jpg') }}"></div>
                                                </div>
                                            </a>
                                        ...
                                        <div class="list-post-wrap  fl-wrap">
                                            ...
                                            <div class="list-post fl-wrap">
                                                <div class="list-post-media">
                                                    <a href="post-single.html">
                                                        <div class="bg-wrap">
                                                            <div class="bg" data-bg="{{ asset('front/images/all/5.jpg') }}"></div>
                                                        </div>
                                                    </a>
                                                    <span class="post-media_title">&copy; Image Copyrights Title</span>
                                                </div>
                                                <div class="list-post-content">
                                                    <a class="post-category-marker" href="#">Sports</a>
                                                    <h3><a href="post-single.html">Winton SuperSprint cars
                                                            cancelled</a></h3>
                                                    <span class="post-date"><i class="far fa-clock"></i> 18 may
                                                        2022</span>
                                                    ...
                                                    <div class="author-link"><a href="author-single.html"><img
                                                                src="{{ asset('front/images/avatar/1.jpg') }}" alt=""> <span>By
                                                                Jane Taylor</span></a></div>
                                                </div>
                                            </div>
                                            <!--list-post end-->
                                            <!--list-post-->
                                            <div class="list-post fl-wrap">
                                                <div class="list-post-media">
                                                    <a href="post-single.html">
                                                        <div class="bg-wrap">
                                                            <div class="bg" data-bg="{{ asset('front/images/all/48.jpg') }}"></div>
                                                        </div>
                                                    </a>
                                                    <span class="post-media_title">&copy; Image Copyrights Title</span>
                                                </div>
                                                <div class="list-post-content">
                                                    ...
                                                    <div class="author-link"><a href="author-single.html"><img
                                                                src="{{ asset('front/images/avatar/2.jpg') }}" alt=""> <span>By
                                                                Mark Rose</span></a></div>
                                                </div>
                                            </div>
                                            <!--list-post end-->
                                            <!--list-post-->
                                            <div class="list-post fl-wrap">
                                                <div class="list-post-media">
                                                    <a href="post-single.html">
                                                        <div class="bg-wrap">
                                                            <div class="bg" data-bg="{{ asset('front/images/all/2.jpg') }}"></div>
                                                        </div>
                                                    </a>
                                                    <span class="post-media_title">&copy; Image Copyrights Title</span>
                                                </div>
                                            ...
                                            <div class="list-post fl-wrap">
                                                <div class="list-post-media">
                                                    <a href="post-single.html">
                                                        <div class="bg-wrap">
                                                            <div class="bg" data-bg="{{ asset('front/images/all/49.jpg') }}"></div>
                                                        </div>
                                                    </a>
                                                    <span class="post-media_title">&copy; Image Copyrights Title</span>
                                                </div>
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="grid-post-item  bold_gpi  fl-wrap">
                                            <div class="grid-post-media gpm_sing">
                                                <div class="bg" data-bg="{{ asset('front/images/all/50.jpg') }}"></div>
                                                <div class="author-link"><a href="author-single.html"><img
                                                            src="{{ asset('front/images/avatar/2.jpg') }}" alt=""> <span>By Mark
                                                            Rose</span></a></div>
                                                <div class="grid-post-media_title">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="grid-post-item  bold_gpi  fl-wrap">
                                            <div class="grid-post-media gpm_sing">
                                                <div class="bg" data-bg="{{ asset('front/images/all/53.jpg') }}"></div>
                                                <div class="author-link"><a href="author-single.html"><img
                                                            src="{{ asset('front/images/avatar/3.jpg') }}" alt=""> <span>By Ann
                                                            Kowalsky</span></a></div>
                                                <div class="grid-post-media_title">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="grid-post-item  bold_gpi  fl-wrap">
                                            <div class="grid-post-media gpm_sing">
                                                <div class="bg" data-bg="{{ asset('front/images/all/52.jpg') }}"></div>
                                                <div class="author-link"><a href="author-single.html"><img
                                                            src="{{ asset('front/images/avatar/1.jpg') }}" alt=""> <span>By Jane
                                                            Taylor</span></a></div>
                                                <div class="grid-post-media_title">
        ...
        <div class="cookie-info-bar">
            <div class="container">
                <div class="cookie-info-bar_title"><i class="fal fa-cookie"></i>Our site uses cookies. Learn more
                    about our use of cookies: <a href="#">Cookie policy</a></div>
            ...
            <div class="main-register-holder">
                <div class="main-register-wrap fl-wrap">
                    <div class="main-register_bg">
                        <div class="bg-wrap">
                            <div class="bg par-elem " data-bg="{{ asset('front/images/bg/1.jpg') }}"></div>
                            <div class="overlay"></div>
                        </div>
                        <div class="mg_logo"><img src="{{ asset('front/images/logo2.png') }}" alt=""></div>
                    </div>
...
<!-- Mirrored from gmag.kwst.net/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Jan 2023 16:37:51 GMT -->
